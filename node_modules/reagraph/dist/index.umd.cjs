...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("react"), require("@react-three/fiber"), require("d3-force-3d"), require("d3-hierarchy"), require("graphology-layout/circular.js"), require("graphology-layout-noverlap"), require("graphology-layout-forceatlas2"), require("graphology-layout/random.js"), require("graphology-metrics/centrality/pagerank.js"), require("graphology-metrics/centrality/degree.js"), require("d3-scale"), require("zustand"), require("zustand/shallow"), require("three"), require("graphology-shortest-path"), require("graphology"), require("@react-spring/three"), require("@react-three/drei"), require("ellipsize"), require("@use-gesture/react"), require("three-stdlib"), require("camera-controls"), require("hold-event"), require("classnames")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "react", "@react-three/fiber", "d3-force-3d", "d3-hierarchy", "graphology-layout/circular.js", "graphology-layout-noverlap", "graphology-layout-forceatlas2", "graphology-layout/random.js", "graphology-metrics/centrality/pagerank.js", "graphology-metrics/centrality/degree.js", "d3-scale", "zustand", "zustand/shallow", "three", "graphology-shortest-path", "graphology", "@react-spring/three", "@react-three/drei", "ellipsize", "@use-gesture/react", "three-stdlib", "camera-controls", "hold-event", "classnames"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.reagraph = {}, global.jsxRuntime, global.React, global.fiber, global.d3Force3d, global.d3Hierarchy, global.circular, global.noverlapLayout, global.forceAtlas2Layout, global.random, global.pagerank, global.degree_js, global.d3Scale, global.zustand, global.shallow, global.three, global.graphologyShortestPath, global.Graph, global.three$1, global.drei, global.ellipsize, global.react, global.threeStdlib, global.ThreeCameraControls, global.holdEvent, global.classNames));
})(this, function(exports2, jsxRuntime, React, fiber, d3Force3d, d3Hierarchy, circular, noverlapLayout, forceAtlas2Layout, random, pagerank, degree_js, d3Scale, zustand, shallow, three, graphologyShortestPath, Graph, three$1, drei, ellipsize, react, threeStdlib, ThreeCameraControls, holdEvent, classNames) {
  "use strict";
  var _a, _b;
  ...
  function calculateEdgeCurveOffset({ edge, edges, curved }) {
    ...
    if (parallelEdges.length > 1) {
      ...
      if (parallelEdges.length === 2) {
        curveOffset = edgeIndex === 0 ? MULTI_EDGE_OFFSET_FACTOR : -0.7;
      } else {
  ...
  const createStore = ({
    ...
    return {
      theme: {
        ...theme,
        edge: {
          ...theme == null ? void 0 : theme.edge,
          label: {
            ...(_a2 = theme == null ? void 0 : theme.edge) == null ? void 0 : _a2.label,
            fontSize: ((_c = (_b2 = theme == null ? void 0 : theme.edge) == null ? void 0 : _b2.label) == null ? void 0 : _c.fontSize) ?? 6
          }
        }
      },
      edges: [],
      ...
      setNodePosition: (id, position) => set((state) => {
        ...
        if ((_a3 = state.selections) == null ? void 0 : _a3.includes(id)) {
          (_b3 = state.selections) == null ? void 0 : _b3.forEach((id2) => {
  ...
  const Label = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(drei.Billboard, { position: [0, 0, 1], children: /* @__PURE__ */ jsxRuntime.jsx(
      drei.Text,
      {
        font: fontUrl,
        fontSize,
  ...
  const Edge$1 = ({
    ...
    const hasSelections = useStore((state) => {
      var _a3;
      return (_a3 = state.selections) == null ? void 0 : _a3.length;
    });
    ...
    const labelComponent = React.useMemo(
      () => {
        var _a3, _b3, _c2, _d2;
        return labelVisible && label && /* @__PURE__ */ jsxRuntime.jsxs(
          three$1.a.group,
          {
            position: labelPosition,
            onContextMenu: () => {
            ...
            children: [
              ...
              subLabel && /* @__PURE__ */ jsxRuntime.jsx("group", { position: [subLabelOffset.x, subLabelOffset.y, 0], children: /* @__PURE__ */ jsxRuntime.jsx(
                Label,
                {
                  ...
                  ellipsis: 15,
                  fontUrl: labelFontUrl,
                  stroke: ((_a3 = theme.edge.subLabel) == null ? void 0 : _a3.stroke) || theme.edge.label.stroke,
                  color: isSelected || active || isActive ? ((_b3 = theme.edge.subLabel) == null ? void 0 : _b3.activeColor) || theme.edge.label.activeColor : ((_c2 = theme.edge.subLabel) == null ? void 0 : _c2.color) || theme.edge.label.color,
                  opacity: selectionOpacity,
                  fontSize: ((_d2 = theme.edge.subLabel) == null ? void 0 : _d2.fontSize) || theme.edge.label.fontSize * 0.8,
                  rotation: labelRotation
                }
              ) })
            ]
      ...
      [
        ...
        (_a2 = theme.edge.subLabel) == null ? void 0 : _a2.stroke,
        (_b2 = theme.edge.subLabel) == null ? void 0 : _b2.activeColor,
        (_c = theme.edge.subLabel) == null ? void 0 : _c.color,
        (_d = theme.edge.subLabel) == null ? void 0 : _d.fontSize
      ]
    );
  ...
  const Ring = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(drei.Billboard, { position: [0, 0, 1], children: /* @__PURE__ */ jsxRuntime.jsxs(three$1.a.mesh, { scale: ringSize, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "ringGeometry",
        {
          attach: "geometry",
  ...
  const Node = ({
    ...
    const labelComponent = React.useMemo(
      () => {
        var _a3, _b3, _c2;
        return labelVisible && (labelVisible || isSelected || active) && label && /* @__PURE__ */ jsxRuntime.jsxs(three$1.a.group, { position: labelPosition, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            Label,
            {
              text: label,
  ...
  const CameraControls = React.forwardRef(
    ({
      ...
      React.useEffect(() => {
        if (!isServerRender) {
          setKeyControls({
            leftKey: new holdEvent__namespace.KeyboardKeyHold(KEY_CODES.ARROW_LEFT, 100),
            rightKey: new holdEvent__namespace.KeyboardKeyHold(KEY_CODES.ARROW_RIGHT, 100),
            upKey: new holdEvent__namespace.KeyboardKeyHold(KEY_CODES.ARROW_UP, 100),
            downKey: new holdEvent__namespace.KeyboardKeyHold(KEY_CODES.ARROW_DOWN, 100)
          });
        }
      }, []);
      React.useEffect(() => {
      ...
      (event) => {
        if (isDownRef.current) {
          ...
          requestAnimationFrame(() => {
            ...
            onLasso == null ? void 0 : onLasso(allSelected);
          });
