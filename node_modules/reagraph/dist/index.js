...
import { Vector3, QuadraticBezierCurve3, LineCurve3, Color, Plane, Vector2, DoubleSide, TubeGeometry, Euler, BoxGeometry, CylinderGeometry, Quaternion, BufferAttribute, Mesh, TextureLoader, LinearFilter, Box3, MathUtils, Raycaster, Sphere as Sphere$1, Spherical, Matrix4, Vector4, MOUSE, Scene } from "three";
import { bidirectional } from "graphology-shortest-path";
import Graph from "graphology";
import { useSpring, a } from "@react-spring/three";
import { Billboard, Text, useCursor, Html, Svg as Svg$1 } from "@react-three/drei";
...
const Edge$1 = ({
  ...
  const labelComponent = useMemo(
    () => {
      var _a3, _b3, _c2, _d2;
      return labelVisible && label && /* @__PURE__ */ jsxs(
        a.group,
        {
          position: labelPosition,
          onContextMenu: () => {
...
const Node = ({
  ...
  const labelComponent = useMemo(
    () => {
      var _a3, _b3, _c2;
      return labelVisible && (labelVisible || isSelected || active) && label && /* @__PURE__ */ jsxs(a.group, { position: labelPosition, children: [
        /* @__PURE__ */ jsx(
          Label,
          {
            text: label,
